...
from autorest.codegen.models.imports import ImportType, FileImport, TypingSection
...
def _get_import_clauses(imports: Dict[ImportType, Dict[str, Set[Optional[str]]]], delimiter: str) -> List[str]:
    return [
        _serialize_type(imports[import_type], delimiter)
...
class FileImportSerializer:
    ...
    def _switch_typing_section_key(self, new_key: TypingSection):
        return {new_key: self._file_import.imports[TypingSection.CONDITIONAL]}
